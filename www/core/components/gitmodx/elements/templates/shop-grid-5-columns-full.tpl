                            ...
                            <div class="mobile-header__body">
                                ...
                                <div class="search search--location--mobile-header mobile-header__search">
                                    <div class="search__body">
                                        <form class="search__form" action="shop-grid-5-columns-full.html">
                    ...
                    <div class="site-header__topbar topbar">
                        <div class="topbar__container container">
                            <div class="topbar__row">
                                ...
                                <div class="topbar__item topbar__item--link"><a class="topbar-link" href="shop-grid-5-columns-full.html">Store Location</a></div>
                                            ...
                                            <div class="menu menu--layout--topbar">
                                                ...
                                                <ul class="menu__list">
                                                    <li class="menu__item">
                                                        <!-- This is a synthetic element that allows to adjust the vertical offset of the submenu using CSS. -->
                                                        <div class="menu__item-submenu-offset"></div>
                                                        <a class="menu__item-link" href="shop-grid-5-columns-full.html">€ Euro</a>
                                                    </li>
                                                    <li class="menu__item">
                                                        <!-- This is a synthetic element that allows to adjust the vertical offset of the submenu using CSS. -->
                                                        <div class="menu__item-submenu-offset"></div>
                                                        <a class="menu__item-link" href="shop-grid-5-columns-full.html">£ Pound Sterling</a>
                                                    </li>
                                                    <li class="menu__item">
                                                        <!-- This is a synthetic element that allows to adjust the vertical offset of the submenu using CSS. -->
                                                        <div class="menu__item-submenu-offset"></div>
                                                        <a class="menu__item-link" href="shop-grid-5-columns-full.html">$ US Dollar</a>
                                                    </li>
                                                    <li class="menu__item">
                                                        <!-- This is a synthetic element that allows to adjust the vertical offset of the submenu using CSS. -->
                                                        <div class="menu__item-submenu-offset"></div>
                                                        <a class="menu__item-link" href="shop-grid-5-columns-full.html">₽ Russian Ruble</a>
                                                    </li>
                                                </ul>
                                            </div>
                                            <!-- .menu / end -->
                                ...
                                <div class="nav-panel__row">
                                                ...
                                                <div class="departments__links-wrapper">
                                                    ...
                                                    <ul class="departments__links">
                                                        <li class="departments__item">
                                                            <a class="departments__item-link" href="shop-grid-5-columns-full.html">
                                                                    ...
                                                                    <div class="megamenu__body" style="background-image: url('images/megamenu/megamenu-1.jpg');">
                                                                        <div class="row">
                                                                            <div class="col-3">
                                                                                <ul class="megamenu__links megamenu__links--level--0">
                                                                                    <li class="megamenu__item megamenu__item--with-submenu">
                                                                                        <a href="shop-grid-5-columns-full.html">Power Tools</a>
                                                                                        <ul class="megamenu__links megamenu__links--level--1">
                                                                                            <li class="megamenu__item"><a href="shop-grid-5-columns-full.html">Engravers</a></li>
                                                                                            <li class="megamenu__item"><a href="shop-grid-5-columns-full.html">Drills</a></li>
                                                                                            <li class="megamenu__item"><a href="shop-grid-5-columns-full.html">Wrenches</a></li>
                                                                                            <li class="megamenu__item"><a href="shop-grid-5-columns-full.html">Plumbing</a></li>
                                                                                            <li class="megamenu__item"><a href="shop-grid-5-columns-full.html">Wall Chaser</a></li>
                                                                                            <li class="megamenu__item"><a href="shop-grid-5-columns-full.html">Pneumatic Tools</a></li>
                                                                                            <li class="megamenu__item"><a href="shop-grid-5-columns-full.html">Milling Cutters</a></li>
                                                                                        </ul>
                                                                                    </li>
                                                                                    <li class="megamenu__item"><a href="shop-grid-5-columns-full.html">Workbenches</a></li>
                                                                                    <li class="megamenu__item"><a href="shop-grid-5-columns-full.html">Presses</a></li>
                                                                                    <li class="megamenu__item"><a href="shop-grid-5-columns-full.html">Spray Guns</a></li>
                                                                                    <li class="megamenu__item"><a href="shop-grid-5-columns-full.html">Riveters</a></li>
                                                                                </ul>
                                                                            </div>
                                                                            <div class="col-3">
                                                                                <ul class="megamenu__links megamenu__links--level--0">
                                                                                    <li class="megamenu__item megamenu__item--with-submenu">
                                                                                        <a href="shop-grid-5-columns-full.html">Hand Tools</a>
                                                                                        <ul class="megamenu__links megamenu__links--level--1">
                                                                                            <li class="megamenu__item"><a href="shop-grid-5-columns-full.html">Screwdrivers</a></li>
                                                                                            <li class="megamenu__item"><a href="shop-grid-5-columns-full.html">Handsaws</a></li>
                                                                                            <li class="megamenu__item"><a href="shop-grid-5-columns-full.html">Knives</a></li>
                                                                                            <li class="megamenu__item"><a href="shop-grid-5-columns-full.html">Axes</a></li>
                                                                                            <li class="megamenu__item"><a href="shop-grid-5-columns-full.html">Multitools</a></li>
                                                                                            <li class="megamenu__item"><a href="shop-grid-5-columns-full.html">Paint Tools</a></li>
                                                                                        </ul>
                                                                                    </li>
                                                                                    <li class="megamenu__item megamenu__item--with-submenu">
                                                                                        <a href="shop-grid-5-columns-full.html">Garden Equipment</a>
                                                                                        <ul class="megamenu__links megamenu__links--level--1">
                                                                                            <li class="megamenu__item"><a href="shop-grid-5-columns-full.html">Motor Pumps</a></li>
                                                                                            <li class="megamenu__item"><a href="shop-grid-5-columns-full.html">Chainsaws</a></li>
                                                                                            <li class="megamenu__item"><a href="shop-grid-5-columns-full.html">Electric Saws</a></li>
                                                                                            <li class="megamenu__item"><a href="shop-grid-5-columns-full.html">Brush Cutters</a></li>
                                                                                        </ul>
                                                                                    </li>
                                                                                </ul>
                                                                            </div>
                                                                            <div class="col-3">
                                                                                <ul class="megamenu__links megamenu__links--level--0">
                                                                                    <li class="megamenu__item megamenu__item--with-submenu">
                                                                                        <a href="shop-grid-5-columns-full.html">Machine Tools</a>
                                                                                        <ul class="megamenu__links megamenu__links--level--1">
                                                                                            <li class="megamenu__item"><a href="shop-grid-5-columns-full.html">Thread Cutting</a></li>
                                                                                            <li class="megamenu__item"><a href="shop-grid-5-columns-full.html">Chip Blowers</a></li>
                                                                                            <li class="megamenu__item"><a href="shop-grid-5-columns-full.html">Sharpening Machines</a></li>
                                                                                            <li class="megamenu__item"><a href="shop-grid-5-columns-full.html">Pipe Cutters</a></li>
                                                                                            <li class="megamenu__item"><a href="shop-grid-5-columns-full.html">Slotting machines</a></li>
                                                                                            <li class="megamenu__item"><a href="shop-grid-5-columns-full.html">Lathes</a></li>
                                                                                        </ul>
                                                                                    </li>
                                                                                </ul>
                                                                            </div>
                                                                            <div class="col-3">
                                                                                <ul class="megamenu__links megamenu__links--level--0">
                                                                                    <li class="megamenu__item megamenu__item--with-submenu">
                                                                                        <a href="shop-grid-5-columns-full.html">Instruments</a>
                                                                                        <ul class="megamenu__links megamenu__links--level--1">
                                                                                            <li class="megamenu__item"><a href="shop-grid-5-columns-full.html">Welding Equipment</a></li>
                                                                                            <li class="megamenu__item"><a href="shop-grid-5-columns-full.html">Power Tools</a></li>
                                                                                            <li class="megamenu__item"><a href="shop-grid-5-columns-full.html">Hand Tools</a></li>
                                                                                            <li class="megamenu__item"><a href="shop-grid-5-columns-full.html">Measuring Tool</a></li>
                                                                                        </ul>
                                                                                    </li>
                                                                                </ul>
                                                                            </div>
                                                                ...
                                                                <div class="menu menu--layout--classic">
                                                                    ...
                                                                    <ul class="menu__list">
                                                                                ...
                                                                                <div class="menu menu--layout--classic">
                                                                                    ...
                                                                                    <ul class="menu__list">
                                                                                        <li class="menu__item">
                                                                                            <!-- This is a synthetic element that allows to adjust the vertical offset of the submenu using CSS. -->
                                                                                            <div class="menu__item-submenu-offset"></div>
                                                                                            <a class="menu__item-link" href="shop-grid-5-columns-full.html">Soldering Station</a>
                                                                                        </li>
                                                                                        <li class="menu__item">
                                                                                            <!-- This is a synthetic element that allows to adjust the vertical offset of the submenu using CSS. -->
                                                                                            <div class="menu__item-submenu-offset"></div>
                                                                                            <a class="menu__item-link" href="shop-grid-5-columns-full.html">Soldering Dryers</a>
                                                                                        </li>
                                                                                        <li class="menu__item">
                                                                                            <!-- This is a synthetic element that allows to adjust the vertical offset of the submenu using CSS. -->
                                                                                            <div class="menu__item-submenu-offset"></div>
                                                                                            <a class="menu__item-link" href="shop-grid-5-columns-full.html">Gas Soldering Iron</a>
                                                                                        </li>
                                                                                        <li class="menu__item">
                                                                                            <!-- This is a synthetic element that allows to adjust the vertical offset of the submenu using CSS. -->
                                                                                            <div class="menu__item-submenu-offset"></div>
                                                                                            <a class="menu__item-link" href="shop-grid-5-columns-full.html">Electric Soldering Iron</a>
                                                                                        </li>
                                                                                    </ul>
                                                                                </div>
                                                                                <!-- .menu / end -->
                                                                        ...
                                                                        <li class="menu__item">
                                                                            <!-- This is a synthetic element that allows to adjust the vertical offset of the submenu using CSS. -->
                                                                            <div class="menu__item-submenu-offset"></div>
                                                                            <a class="menu__item-link" href="shop-grid-5-columns-full.html">Light Bulbs</a>
                                                                        </li>
                                                                        <li class="menu__item">
                                                                            <!-- This is a synthetic element that allows to adjust the vertical offset of the submenu using CSS. -->
                                                                            <div class="menu__item-submenu-offset"></div>
                                                                            <a class="menu__item-link" href="shop-grid-5-columns-full.html">Batteries</a>
                                                                        </li>
                                                                        <li class="menu__item">
                                                                            <!-- This is a synthetic element that allows to adjust the vertical offset of the submenu using CSS. -->
                                                                            <div class="menu__item-submenu-offset"></div>
                                                                            <a class="menu__item-link" href="shop-grid-5-columns-full.html">Light Fixtures</a>
                                                                        </li>
                                                                        <li class="menu__item">
                                                                            <!-- This is a synthetic element that allows to adjust the vertical offset of the submenu using CSS. -->
                                                                            <div class="menu__item-submenu-offset"></div>
                                                                            <a class="menu__item-link" href="shop-grid-5-columns-full.html">Warm Floor</a>
                                                                        </li>
                                                                        <li class="menu__item">
                                                                            <!-- This is a synthetic element that allows to adjust the vertical offset of the submenu using CSS. -->
                                                                            <div class="menu__item-submenu-offset"></div>
                                                                            <a class="menu__item-link" href="shop-grid-5-columns-full.html">Generators</a>
                                                                        </li>
                                                                        <li class="menu__item">
                                                                            <!-- This is a synthetic element that allows to adjust the vertical offset of the submenu using CSS. -->
                                                                            <div class="menu__item-submenu-offset"></div>
                                                                            <a class="menu__item-link" href="shop-grid-5-columns-full.html">UPS</a>
                                                                        </li>
                                                                    </ul>
                                                                </div>
                                                                <!-- .menu / end -->
                                                        ...
                                                        <li class="departments__item"><a class="departments__item-link" href="shop-grid-5-columns-full.html">Power Machinery</a></li>
                                                        <li class="departments__item"><a class="departments__item-link" href="shop-grid-5-columns-full.html">Measurement</a></li>
                                                        <li class="departments__item"><a class="departments__item-link" href="shop-grid-5-columns-full.html">Clothes & PPE</a></li>
                                                        <li class="departments__item"><a class="departments__item-link" href="shop-grid-5-columns-full.html">Plumbing</a></li>
                                                        <li class="departments__item"><a class="departments__item-link" href="shop-grid-5-columns-full.html">Storage & Organization</a></li>
                                                        <li class="departments__item"><a class="departments__item-link" href="shop-grid-5-columns-full.html">Welding & Soldering</a></li>
                                                    </ul>
                                                </div>
                                            </div>
                                    ...
                                    <div class="nav-panel__nav-links nav-links">
                                        <ul class="nav-links__list">
                                            ...
                                            <li class="nav-links__item nav-links__item--has-submenu">
                                                <a class="nav-links__item-link" href="shop-grid-5-columns-full.html">
                                                    <div class="nav-links__item-body">
                                                    ...
                                                    <form class="account-menu__form">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="account-menu__form-forgot">
                                                                ...
                                                                <a href="shop-grid-5-columns-full.html" class="account-menu__form-forgot-link">Forgot?</a>
                                                            </div>
                                                        </div>
                        ...
                        <div class="page-header__breadcrumb">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item">
                                        <a href="shop-grid-5-columns-full.html">Breadcrumb</a> <svg class="breadcrumb-arrow" width="6px" height="9px"><use xlink:href="assets/theme/images/sprite.svg#arrow-rounded-right-6x9"></use></svg>
                                    </li>
                                    ...
                                    <div class="products-view__pagination">
                                        <ul class="pagination justify-content-center">
                                            <li class="page-item disabled">
                                                <a class="page-link page-link--with-arrow" href="shop-grid-5-columns-full.html" aria-label="Previous">
                                            ...
                                            <li class="page-item"><a class="page-link" href="shop-grid-5-columns-full.html">1</a></li>
                                            <li class="page-item active">
                                                <a class="page-link" href="shop-grid-5-columns-full.html">2 <span class="sr-only">(current)</span></a>
                                            </li>
                                            <li class="page-item"><a class="page-link" href="shop-grid-5-columns-full.html">3</a></li>
                                            <li class="page-item">
                                                <a class="page-link page-link--with-arrow" href="shop-grid-5-columns-full.html" aria-label="Next">
                                                        ...
                                                        <div class="filter-categories">
                                                            <ul class="filter-categories__list">
                                                                <li class="filter-categories__item filter-categories__item--parent">
                                                                    ...
                                                                    <a href="shop-grid-5-columns-full.html">Construction & Repair</a>
                                                                ...
                                                                <li class="filter-categories__item filter-categories__item--child">
                                                                    <a href="shop-grid-5-columns-full.html">Drills & Mixers</a>
                                                                    <div class="filter-categories__counter">15</div>
                                                                </li>
                                                                <li class="filter-categories__item filter-categories__item--child">
                                                                    <a href="shop-grid-5-columns-full.html">Cordless Screwdrivers</a>
                                                                    <div class="filter-categories__counter">2</div>
                                                                </li>
                                                                <li class="filter-categories__item filter-categories__item--child">
                                                                    <a href="shop-grid-5-columns-full.html">Screwdrivers</a>
                                                                    <div class="filter-categories__counter">30</div>
                                                                </li>
                                                                <li class="filter-categories__item filter-categories__item--child">
                                                                    <a href="shop-grid-5-columns-full.html">Wrenches</a>
                                                                    <div class="filter-categories__counter">7</div>
                                                                </li>
                                                                <li class="filter-categories__item filter-categories__item--child">
                                                                    <a href="shop-grid-5-columns-full.html">Grinding Machines</a>
                                                                    <div class="filter-categories__counter">5</div>
                                                                </li>
                                                                <li class="filter-categories__item filter-categories__item--child">
                                                                    <a href="shop-grid-5-columns-full.html">Milling Cutters</a>
                                                                    <div class="filter-categories__counter">2</div>
                                                                </li>
                                                                <li class="filter-categories__item filter-categories__item--child">
                                                                    <a href="shop-grid-5-columns-full.html">Electric Spray Guns</a>
                                                                    <div class="filter-categories__counter">9</div>
                                                                </li>
                                                                <li class="filter-categories__item filter-categories__item--child">
                                                                    <a href="shop-grid-5-columns-full.html">Jigsaws</a>
                                                                    <div class="filter-categories__counter">4</div>
                                                                </li>
                                                                <li class="filter-categories__item filter-categories__item--child">
                                                                    <a href="shop-grid-5-columns-full.html">Jackhammers</a>
                                                                    <div class="filter-categories__counter">0</div>
                                                                </li>
                                                                <li class="filter-categories__item filter-categories__item--child">
                                                                    <a href="shop-grid-5-columns-full.html">Planers</a>
                                                                    <div class="filter-categories__counter">12</div>
                                                                </li>
                                                                <li class="filter-categories__item filter-categories__item--child">
                                                                    <a href="shop-grid-5-columns-full.html">Glue Guns</a>
                                                                    <div class="filter-categories__counter">7</div>
                                                                </li>
                                                            </ul>
                                                        </div>
                                                    ...
                                                    <div class="filter__container">
                                                        <div class="filter-categories-alt">
                                                            <ul class="filter-categories-alt__list filter-categories-alt__list--level--1" data-collapse-opened-class="filter-categories-alt__item--open">
                                                                <li class="filter-categories-alt__item" data-collapse-item><a href="shop-grid-5-columns-full.html">Clothes & PPE</a></li>
                                                                <li class="filter-categories-alt__item" data-collapse-item>
                                                                    <button class="filter-categories-alt__expander" data-collapse-trigger></button> <a href="shop-grid-5-columns-full.html">Power Tools</a>
                                                                    <div class="filter-categories-alt__children" data-collapse-content>
                                                                        <ul class="filter-categories-alt__list filter-categories-alt__list--level--2">
                                                                            <li class="filter-categories-alt__item" data-collapse-item><a href="shop-grid-5-columns-full.html">Engravers</a></li>
                                                                            <li class="filter-categories-alt__item" data-collapse-item><a href="shop-grid-5-columns-full.html">Drills</a></li>
                                                                            <li class="filter-categories-alt__item" data-collapse-item><a href="shop-grid-5-columns-full.html">Wrenches</a></li>
                                                                            <li class="filter-categories-alt__item" data-collapse-item><a href="shop-grid-5-columns-full.html">Plumbing</a></li>
                                                                            <li class="filter-categories-alt__item" data-collapse-item><a href="shop-grid-5-columns-full.html">Wall Chaser</a></li>
                                                                            <li class="filter-categories-alt__item" data-collapse-item><a href="shop-grid-5-columns-full.html">Pneumatic Tools</a></li>
                                                                            <li class="filter-categories-alt__item" data-collapse-item><a href="shop-grid-5-columns-full.html">Milling Cutters</a></li>
                                                                        </ul>
                                                                    </div>
                                                                </li>
                                                                <li class="filter-categories-alt__item filter-categories-alt__item--open filter-categories-alt__item--current" data-collapse-item>
                                                                    <button class="filter-categories-alt__expander" data-collapse-trigger></button> <a href="shop-grid-5-columns-full.html">Hand Tools</a>
                                                                    <div class="filter-categories-alt__children" data-collapse-content>
                                                                        <ul class="filter-categories-alt__list filter-categories-alt__list--level--2">
                                                                            <li class="filter-categories-alt__item" data-collapse-item><a href="shop-grid-5-columns-full.html">Screwdrivers</a></li>
                                                                            <li class="filter-categories-alt__item filter-categories-alt__item--current" data-collapse-item>
                                                                                <button class="filter-categories-alt__expander" data-collapse-trigger></button> <a href="shop-grid-5-columns-full.html">Handsaws</a>
                                                                                <div class="filter-categories-alt__children" data-collapse-content>
                                                                                    <ul class="filter-categories-alt__list filter-categories-alt__list--level--3">
                                                                                        <li class="filter-categories-alt__item" data-collapse-item><a href="shop-grid-5-columns-full.html">Power Saws</a></li>
                                                                                        <li class="filter-categories-alt__item" data-collapse-item><a href="shop-grid-5-columns-full.html">Hacksaws</a></li>
                                                                                        <li class="filter-categories-alt__item filter-categories-alt__item--current" data-collapse-item>
                                                                                            <button class="filter-categories-alt__expander" data-collapse-trigger></button> <a href="shop-grid-5-columns-full.html">Deep Dive</a>
                                                                                            <div class="filter-categories-alt__children" data-collapse-content>
                                                                                                <ul class="filter-categories-alt__list filter-categories-alt__list--level--4">
                                                                                                    <li class="filter-categories-alt__item" data-collapse-item><a href="shop-grid-5-columns-full.html">Submarines</a></li>
                                                                                                    <li class="filter-categories-alt__item" data-collapse-item><a href="shop-grid-5-columns-full.html">Silt In Bags</a></li>
                                                                                                    <li class="filter-categories-alt__item" data-collapse-item><a href="shop-grid-5-columns-full.html">Black Pearl</a></li>
                                                                                                    <li class="filter-categories-alt__item" data-collapse-item><a href="shop-grid-5-columns-full.html">Krakens</a></li>
                                                                                                    <li class="filter-categories-alt__item" data-collapse-item><a href="shop-grid-5-columns-full.html">Nautilus</a></li>
                                                                                                    <li class="filter-categories-alt__item" data-collapse-item><a href="shop-grid-5-columns-full.html">Mariana Trench</a></li>
                                                                                                </ul>
                                                                                            </div>
                                                                                        </li>
                                                                                        <li class="filter-categories-alt__item" data-collapse-item><a href="shop-grid-5-columns-full.html">Chain Saws</a></li>
                                                                                        <li class="filter-categories-alt__item" data-collapse-item><a href="shop-grid-5-columns-full.html">Two-handed Saws</a></li>
                                                                                        <li class="filter-categories-alt__item" data-collapse-item><a href="shop-grid-5-columns-full.html">Other</a></li>
                                                                                    </ul>
                                                                                </div>
                                                                            </li>
                                                                            <li class="filter-categories-alt__item" data-collapse-item><a href="shop-grid-5-columns-full.html">Knives</a></li>
                                                                            <li class="filter-categories-alt__item" data-collapse-item><a href="shop-grid-5-columns-full.html">Axes</a></li>
                                                                            <li class="filter-categories-alt__item" data-collapse-item><a href="shop-grid-5-columns-full.html">Multitools</a></li>
                                                                            <li class="filter-categories-alt__item" data-collapse-item><a href="shop-grid-5-columns-full.html">Paint Tools</a></li>
                                                                        </ul>
                                                                    </div>
                                                                </li>
                                                                <li class="filter-categories-alt__item" data-collapse-item><a href="shop-grid-5-columns-full.html">Measurement</a></li>
                                                                <li class="filter-categories-alt__item" data-collapse-item>
                                                                    <button class="filter-categories-alt__expander" data-collapse-trigger></button> <a href="shop-grid-5-columns-full.html">Garden Equipment</a>
                                                                    <div class="filter-categories-alt__children" data-collapse-content>
                                                                        <ul class="filter-categories-alt__list filter-categories-alt__list--level--2">
                                                                            <li class="filter-categories-alt__item" data-collapse-item><a href="shop-grid-5-columns-full.html">Motor Pumps</a></li>
                                                                            <li class="filter-categories-alt__item" data-collapse-item><a href="shop-grid-5-columns-full.html">Chainsaws</a></li>
                                                                            <li class="filter-categories-alt__item" data-collapse-item><a href="shop-grid-5-columns-full.html">Electric Saws</a></li>
                                                                            <li class="filter-categories-alt__item" data-collapse-item><a href="shop-grid-5-columns-full.html">Brush Cutters</a></li>
                                                                        </ul>
                                                                    </div>
                                                                </li>
                                                            </ul>
                            ...
                            <div class="row">
                                ...
                                <div class="col-6 col-md-3 col-lg-2">
                                    <div class="site-footer__widget footer-links">
                                        ...
                                        <ul class="footer-links__list">
                                            <li class="footer-links__item"><a href="shop-grid-5-columns-full.html" class="footer-links__link">About Us</a></li>
                                            <li class="footer-links__item"><a href="shop-grid-5-columns-full.html" class="footer-links__link">Delivery Information</a></li>
                                            <li class="footer-links__item"><a href="shop-grid-5-columns-full.html" class="footer-links__link">Privacy Policy</a></li>
                                            <li class="footer-links__item"><a href="shop-grid-5-columns-full.html" class="footer-links__link">Brands</a></li>
                                            <li class="footer-links__item"><a href="shop-grid-5-columns-full.html" class="footer-links__link">Contact Us</a></li>
                                            <li class="footer-links__item"><a href="shop-grid-5-columns-full.html" class="footer-links__link">Returns</a></li>
                                            <li class="footer-links__item"><a href="shop-grid-5-columns-full.html" class="footer-links__link">Site Map</a></li>
                                        </ul>
                                    </div>
                                </div>
                                <div class="col-6 col-md-3 col-lg-2">
                                    <div class="site-footer__widget footer-links">
                                        ...
                                        <ul class="footer-links__list">
                                            <li class="footer-links__item"><a href="shop-grid-5-columns-full.html" class="footer-links__link">Store Location</a></li>
                                            <li class="footer-links__item"><a href="shop-grid-5-columns-full.html" class="footer-links__link">Order History</a></li>
                                            <li class="footer-links__item"><a href="shop-grid-5-columns-full.html" class="footer-links__link">Wish List</a></li>
                                            <li class="footer-links__item"><a href="shop-grid-5-columns-full.html" class="footer-links__link">Newsletter</a></li>
                                            <li class="footer-links__item"><a href="shop-grid-5-columns-full.html" class="footer-links__link">Specials</a></li>
                                            <li class="footer-links__item"><a href="shop-grid-5-columns-full.html" class="footer-links__link">Gift Certificates</a></li>
                                            <li class="footer-links__item"><a href="shop-grid-5-columns-full.html" class="footer-links__link">Affiliate</a></li>
                                        </ul>
                                    </div>
                                </div>
                                <div class="col-12 col-md-12 col-lg-4">
                                    <div class="site-footer__widget footer-newsletter">
                                        ...
                                        <form action="shop-grid-5-columns-full.html" class="footer-newsletter__form">
                                        ...
                                        <div class="social-links footer-newsletter__social-links social-links--shape--circle">
                                            <ul class="social-links__list">
                                                <li class="social-links__item">
                                                    <a class="social-links__link social-links__link--type--rss" href="shop-grid-5-columns-full.html" target="_blank"><i class="fas fa-rss"></i></a>
                                                </li>
                                                <li class="social-links__item">
                                                    <a class="social-links__link social-links__link--type--youtube" href="shop-grid-5-columns-full.html" target="_blank"><i class="fab fa-youtube"></i></a>
                                                </li>
                                                <li class="social-links__item">
                                                    <a class="social-links__link social-links__link--type--facebook" href="shop-grid-5-columns-full.html" target="_blank"><i class="fab fa-facebook-f"></i></a>
                                                </li>
                                                <li class="social-links__item">
                                                    <a class="social-links__link social-links__link--type--twitter" href="shop-grid-5-columns-full.html" target="_blank"><i class="fab fa-twitter"></i></a>
                                                </li>
                                                <li class="social-links__item">
                                                    <a class="social-links__link social-links__link--type--instagram" href="shop-grid-5-columns-full.html" target="_blank"><i class="fab fa-instagram"></i></a>
                                                </li>
                                            </ul>
                                        </div>
                                        <!-- social-links / end -->
            ...
            <div class="mobilemenu__body">
                ...
                <div class="mobilemenu__content">
                    <ul class="mobile-links mobile-links--level--0" data-collapse data-collapse-opened-class="mobile-links__item--open">
                        ...
                        <li class="mobile-links__item" data-collapse-item>
                            <div class="mobile-links__item-title">
                                <a href="shop-grid-5-columns-full.html" class="mobile-links__item-link">Categories</a>
                                <button class="mobile-links__item-toggle" type="button" data-collapse-trigger>
                                    <svg class="mobile-links__item-arrow" width="12px" height="7px"><use xlink:href="assets/theme/images/sprite.svg#arrow-rounded-down-12x7"></use></svg>
                                </button>
                            </div>
                            <div class="mobile-links__item-sub-links" data-collapse-content>
                                <ul class="mobile-links mobile-links--level--1">
                                    <li class="mobile-links__item" data-collapse-item>
                                        <div class="mobile-links__item-title">
                                            <a href="shop-grid-5-columns-full.html" class="mobile-links__item-link">Power Tools</a>
                                            <button class="mobile-links__item-toggle" type="button" data-collapse-trigger>
                                                <svg class="mobile-links__item-arrow" width="12px" height="7px"><use xlink:href="assets/theme/images/sprite.svg#arrow-rounded-down-12x7"></use></svg>
                                            </button>
                                        </div>
                                        <div class="mobile-links__item-sub-links" data-collapse-content>
                                            <ul class="mobile-links mobile-links--level--2">
                                                <li class="mobile-links__item" data-collapse-item>
                                                    <div class="mobile-links__item-title"><a href="shop-grid-5-columns-full.html" class="mobile-links__item-link">Engravers</a></div>
                                                </li>
                                                <li class="mobile-links__item" data-collapse-item>
                                                    <div class="mobile-links__item-title"><a href="shop-grid-5-columns-full.html" class="mobile-links__item-link">Wrenches</a></div>
                                                </li>
                                                <li class="mobile-links__item" data-collapse-item>
                                                    <div class="mobile-links__item-title"><a href="shop-grid-5-columns-full.html" class="mobile-links__item-link">Wall Chaser</a></div>
                                                </li>
                                                <li class="mobile-links__item" data-collapse-item>
                                                    <div class="mobile-links__item-title"><a href="shop-grid-5-columns-full.html" class="mobile-links__item-link">Pneumatic Tools</a></div>
                                                </li>
                                            </ul>
                                        </div>
                                    </li>
                                    <li class="mobile-links__item" data-collapse-item>
                                        <div class="mobile-links__item-title">
                                            <a href="shop-grid-5-columns-full.html" class="mobile-links__item-link">Machine Tools</a>
                                            <button class="mobile-links__item-toggle" type="button" data-collapse-trigger>
                                                <svg class="mobile-links__item-arrow" width="12px" height="7px"><use xlink:href="assets/theme/images/sprite.svg#arrow-rounded-down-12x7"></use></svg>
                                            </button>
                                        </div>
                                        <div class="mobile-links__item-sub-links" data-collapse-content>
                                            <ul class="mobile-links mobile-links--level--2">
                                                <li class="mobile-links__item" data-collapse-item>
                                                    <div class="mobile-links__item-title"><a href="shop-grid-5-columns-full.html" class="mobile-links__item-link">Thread Cutting</a></div>
                                                </li>
                                                <li class="mobile-links__item" data-collapse-item>
                                                    <div class="mobile-links__item-title"><a href="shop-grid-5-columns-full.html" class="mobile-links__item-link">Chip Blowers</a></div>
                                                </li>
                                                <li class="mobile-links__item" data-collapse-item>
                                                    <div class="mobile-links__item-title"><a href="shop-grid-5-columns-full.html" class="mobile-links__item-link">Sharpening Machines</a></div>
                                                </li>
                                                <li class="mobile-links__item" data-collapse-item>
                                                    <div class="mobile-links__item-title"><a href="shop-grid-5-columns-full.html" class="mobile-links__item-link">Pipe Cutters</a></div>
                                                </li>
                                                <li class="mobile-links__item" data-collapse-item>
                                                    <div class="mobile-links__item-title"><a href="shop-grid-5-columns-full.html" class="mobile-links__item-link">Slotting machines</a></div>
                                                </li>
                                                <li class="mobile-links__item" data-collapse-item>
                                                    <div class="mobile-links__item-title"><a href="shop-grid-5-columns-full.html" class="mobile-links__item-link">Lathes</a></div>
                                                </li>
                                            </ul>
                                        </div>
                                    </li>
                        ...
                        <li class="mobile-links__item" data-collapse-item>
                            <div class="mobile-links__item-title">
                                <a href="shop-grid-5-columns-full.html" class="mobile-links__item-link">Pages</a>
                                <button class="mobile-links__item-toggle" type="button" data-collapse-trigger>
                                    <svg class="mobile-links__item-arrow" width="12px" height="7px"><use xlink:href="assets/theme/images/sprite.svg#arrow-rounded-down-12x7"></use></svg>
                                </button>
                            </div>
                        ...
                        <li class="mobile-links__item" data-collapse-item>
                            ...
                            <div class="mobile-links__item-sub-links" data-collapse-content>
                                <ul class="mobile-links mobile-links--level--1">
                                    <li class="mobile-links__item" data-collapse-item>
                                        <div class="mobile-links__item-title"><a href="shop-grid-5-columns-full.html" class="mobile-links__item-link">€ Euro</a></div>
                                    </li>
                                    <li class="mobile-links__item" data-collapse-item>
                                        <div class="mobile-links__item-title"><a href="shop-grid-5-columns-full.html" class="mobile-links__item-link">£ Pound Sterling</a></div>
                                    </li>
                                    <li class="mobile-links__item" data-collapse-item>
                                        <div class="mobile-links__item-title"><a href="shop-grid-5-columns-full.html" class="mobile-links__item-link">$ US Dollar</a></div>
                                    </li>
                                    <li class="mobile-links__item" data-collapse-item>
                                        <div class="mobile-links__item-title"><a href="shop-grid-5-columns-full.html" class="mobile-links__item-link">₽ Russian Ruble</a></div>
                                    </li>
                                </ul>
                            </div>
                        </li>
                        <li class="mobile-links__item" data-collapse-item>
                            ...
                            <div class="mobile-links__item-sub-links" data-collapse-content>
                                <ul class="mobile-links mobile-links--level--1">
                                    <li class="mobile-links__item" data-collapse-item>
                                        <div class="mobile-links__item-title"><a href="shop-grid-5-columns-full.html" class="mobile-links__item-link">English</a></div>
                                    </li>
                                    <li class="mobile-links__item" data-collapse-item>
                                        <div class="mobile-links__item-title"><a href="shop-grid-5-columns-full.html" class="mobile-links__item-link">French</a></div>
                                    </li>
                                    <li class="mobile-links__item" data-collapse-item>
                                        <div class="mobile-links__item-title"><a href="shop-grid-5-columns-full.html" class="mobile-links__item-link">German</a></div>
                                    </li>
                                    <li class="mobile-links__item" data-collapse-item>
                                        <div class="mobile-links__item-title"><a href="shop-grid-5-columns-full.html" class="mobile-links__item-link">Russian</a></div>
                                    </li>
                                    <li class="mobile-links__item" data-collapse-item>
                                        <div class="mobile-links__item-title"><a href="shop-grid-5-columns-full.html" class="mobile-links__item-link">Italian</a></div>
                                    </li>
                                </ul>
                            </div>
                        </li>
