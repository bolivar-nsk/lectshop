...
REPLACE INTO `modx_dashboard_widget` VALUES (6,'backupmodx.widget','backupmodx.widget_desc','file','[[++core_path]]components/backupmodx/elements/widgets/backupmodx.widget.php','backupmodx','backupmodx:default','half');
