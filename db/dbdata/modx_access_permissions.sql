...
REPLACE INTO `modx_access_permissions` VALUES (270,12,'mscategory_save','mscategory_save',1);
REPLACE INTO `modx_access_permissions` VALUES (271,12,'msproduct_save','msproduct_save',1);
REPLACE INTO `modx_access_permissions` VALUES (272,12,'msproduct_publish','msproduct_publish',1);
REPLACE INTO `modx_access_permissions` VALUES (273,12,'msproduct_delete','msproduct_delete',1);
REPLACE INTO `modx_access_permissions` VALUES (274,12,'msorder_save','msorder_save',1);
REPLACE INTO `modx_access_permissions` VALUES (275,12,'msorder_view','msorder_view',1);
REPLACE INTO `modx_access_permissions` VALUES (276,12,'msorder_list','msorder_list',1);
REPLACE INTO `modx_access_permissions` VALUES (277,12,'msorder_remove','msorder_remove',1);
REPLACE INTO `modx_access_permissions` VALUES (278,12,'mssetting_save','mssetting_save',1);
REPLACE INTO `modx_access_permissions` VALUES (279,12,'mssetting_view','mssetting_view',1);
REPLACE INTO `modx_access_permissions` VALUES (280,12,'mssetting_list','mssetting_list',1);
REPLACE INTO `modx_access_permissions` VALUES (281,12,'msproductfile_save','msproductfile_save',1);
REPLACE INTO `modx_access_permissions` VALUES (282,12,'msproductfile_generate','msproductfile_generate',1);
REPLACE INTO `modx_access_permissions` VALUES (283,12,'msproductfile_list','msproductfile_list',1);
REPLACE INTO `modx_access_permissions` VALUES (284,1,'delete_weblink','perm.delete_weblink_desc',1);
REPLACE INTO `modx_access_permissions` VALUES (285,1,'delete_symlink','perm.delete_symlink_desc',1);
REPLACE INTO `modx_access_permissions` VALUES (286,1,'delete_static_resource','perm.delete_static_resource_desc',1);
REPLACE INTO `modx_access_permissions` VALUES (287,1,'edit_weblink','perm.edit_weblink_desc',1);
REPLACE INTO `modx_access_permissions` VALUES (288,1,'edit_symlink','perm.edit_symlink_desc',1);
REPLACE INTO `modx_access_permissions` VALUES (289,1,'edit_static_resource','perm.edit_static_resource_desc',1);
