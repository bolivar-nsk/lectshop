...
REPLACE INTO `modx_menus` VALUES ('site','topnav','','','<i class=\"icon icon-large icon-file-text-o\" title=\"Содержимое\"></i>',0,'','','menu_site','core');
REPLACE INTO `modx_menus` VALUES ('preview','topnav','','preview_desc','<i class=\"icon icon-large icon-home\" title=\"На сайт\"></i>',6,'','MODx.preview(); return false;','','core');
REPLACE INTO `modx_menus` VALUES ('refresh_site','topnav','','refresh_site_desc','<i class=\"icon-trash-o icon icon-large\" title=\"Очистить кеш\"></i>',3,'','MODx.clearCache(); return false;','empty_cache','core');
...
REPLACE INTO `modx_menus` VALUES ('topnav','','','topnav_desc','',1,'','','','core');
REPLACE INTO `modx_menus` VALUES ('new_resource','site','resource/create','new_resource_desc','',0,'','','new_document','core');
REPLACE INTO `modx_menus` VALUES ('media','topnav','','media_desc','<i class=\"icon icon-large icon-image\" title=\"Медиа\"></i>',1,'','','file_manager','core');
...
REPLACE INTO `modx_menus` VALUES ('components','topnav','','','<i class=\"icon icon-large icon-cube\" title=\"Пакеты\"></i>',5,'','','components','core');
...
REPLACE INTO `modx_menus` VALUES ('system','','0','','images/misc/logo_tbar.gif',5,'','','menu_system','core');
...
REPLACE INTO `modx_menus` VALUES ('support','','0','support_desc','images/icons/sysinfo.gif',6,'','','menu_support','core');
...
REPLACE INTO `modx_menus` VALUES ('manage','topnav','','','<i class=\"icon icon-large icon-sliders\" title=\"Управление\"></i>',2,'','','menu_tools','core');
REPLACE INTO `modx_menus` VALUES ('users','manage','security/user','user_management_desc','',0,'','','view_user','core');
REPLACE INTO `modx_menus` VALUES ('usernav','','','usernav_desc','',2,'','','','core');
...
REPLACE INTO `modx_menus` VALUES ('moddevtools','components','87','moddevtools_menu_desc','images/icons/plugin.gif',0,'','','view_chunk,view_template','core');
REPLACE INTO `modx_menus` VALUES ('robotsbuilder','components','home','robotsbuilder_menu_desc','',0,'','','','robotsbuilder');
REPLACE INTO `modx_menus` VALUES ('Очистить папку кеша','topnav','','','<i class=\"icon-eraser icon icon-large\" title=\"Очистить папку кеша\"></i>',4,'','window.open(\'../cacheclear/\')','','');
REPLACE INTO `modx_menus` VALUES ('stercseo.seotab','components','home','stercseo.menu_desc','',0,'','','','stercseo');
